...
class Database:
    ...
    def get_watchlist(self) -> List[Dict]:
        ...
        El campo 'category' ya viene incluido desde database.py
        como alias de 'asset_type'.
        """
...
class QuantScheduler:
    ...
    def run_scan(self):
        ...
        for item in watchlist:
            ticker   = item["ticker"]
            category = item["category"]   # ← viene de database.py sin KeyError
